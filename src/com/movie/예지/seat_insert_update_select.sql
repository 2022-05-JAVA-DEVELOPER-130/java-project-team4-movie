...
CREATE SEQUENCE seat_seat_no_seq MINVALUE 1 MAXVALUE 50 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE;

select seat_seat_no_seq.NEXTval from dual;

select seat_seat_no_seq.currval from dual;


insert into seat values(seat_seat_no_seq.nextval,1,1,'1회차',null);
insert into seat values(seat_seat_no_seq.nextval,2,1,'1회차',null);
insert into seat values(seat_seat_no_seq.nextval,3,1,'1회차',null);
insert into seat values(seat_seat_no_seq.nextval,4,1,'1회차',null);
insert into seat values(seat_seat_no_seq.nextval,5,1,'1회차',null);
insert into seat values(seat_seat_no_seq.nextval,6,1,'1회차',null);
insert into seat values(seat_seat_no_seq.nextval,7,1,'1회차',null);
insert into seat values(seat_seat_no_seq.nextval,8,1,'1회차',null);
insert into seat values(seat_seat_no_seq.nextval,9,1,'1회차',null);
insert into seat values(seat_seat_no_seq.nextval,10,1,'1회차',null);
