...
public class PaymentSelect2 {
	DataSource dataSource = new DataSource();
	
	public PaymentSelect2() {
	...
	public int selectDiscount(String id) throws Exception{
		...
		ResultSet rs = pstmt.executeQuery();
		int total_price=0;
		int coupon_effect=(int)(total_price*0.1);
		int coupon_no=0;
		...
		if(coupon_no==1){//true
			System.out.println(coupon_effect);
		}else {//false
